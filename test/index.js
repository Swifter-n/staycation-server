...
describe('API ENDPOINT TESTING', () =>{
    it('GET Landing Page', (done) =>{
        chai.request(app).get('/api/v1/member/landing-page').end((err, res) =>{
            ...
            expect(res.body).to.be.property('mostPicked')
            ...
            expect(res.body).to.be.property('testimonial')
    ...
    it('POST Booking Page', (done) =>{
        ...
        const dataSample = {
            ...
            duration: 2,
            bookingStartDate: '9-09-2021',
            bookingEndDate: '11-09-2021',
            firstName: 'Ibnu',
            lastName: 'Saputra',
            email: 'ibnu@gmail.com',
            phoneNumber: '082183738282',
            accountHolder: 'Ibnu',
            bankFrom: 'Mandiri',
        }
